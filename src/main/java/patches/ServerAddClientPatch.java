...
public class ServerAddClientPatch {
    ...
    static boolean onEnter(@Advice.This Server th, @Advice.Argument(0) NetworkInfo networkInfo, @Advice.Argument(1) long authentication, @Advice.Argument(2) String version,
    		@Advice.Argument(3) boolean craftingUsesNearbyInventories, @Advice.Argument(4) boolean trackNewQuests) {	
			addClient(th, networkInfo, authentication, version, craftingUsesNearbyInventories, trackNewQuests);
			
			DebugHelper.handleDebugMessage("Race Mod intercept client add procedure for Server class.", 50, MESSAGE_TYPE.DEBUG);
		return true;
    }*/
